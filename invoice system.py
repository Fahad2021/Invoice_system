...
class Bill_App:
    ...
    # .......customer .....
        ...
        #...........cold Drinks............
        F4 = LabelFrame(self.root, bd=10, relief=GROOVE, text="Cold Drinks", font=("times new roman", 15, "bold"),fg="white", bg=bg_color)
        F4.place(x=670, y=180,width=325,height=380)
        c1_lbl=Label(F4,text="Maza",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=0,column=0,padx=10,pady=10,sticky='w')
        ...
        c2_lbl=Label(F4,text="7Up",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=1,column=0,padx=10,pady=10,sticky='w')
        ...
        c3_lbl=Label(F4,text="Tiger",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=2,column=0,padx=10,pady=10,sticky='w')
        ...
        c4_lbl=Label(F4,text="Sprite",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=3,column=0,padx=10,pady=10,sticky='w')
        ...
        c5_lbl=Label(F4,text="Fruto",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=4,column=0,padx=10,pady=10,sticky='w')
        ...
        c6__lbl=Label(F4,text="Speed",font=('times new roman',16,"bold"),bg=bg_color,fg=fg).grid(row=5,column=0,padx=10,pady=10,sticky='w')
...
#         .......Button Frame............
        ...
        m1_lbl=Label(F6,text="Total Cosmaetic Price",bg=bg_color,fg=fg,font=("times new roman",14,"bold")).grid(row=0,column=0,padx=20,pady=1,sticky="w")
        m1_txt=Entry(F6,width=18,textvariable=self.cosmetic_price,font="arial 10 bold",bd=7,relief=SUNKEN,).grid(row=0,column=1,padx=10,pady=1)

        m2_lbl = Label(F6, text="Total Grocery Price", bg=bg_color, fg=fg,font=("times new roman", 14, "bold")).grid(row=1, column=0, padx=20, pady=1, sticky="w")
        m2_txt = Entry(F6, width=18,textvariable=self.grocery_price,font="arial 10 bold", bd=7, relief=SUNKEN, ).grid(row=1, column=1, padx=10, pady=1)

        m3_lbl = Label(F6, text="Total Cold Drinks Price", bg=bg_color, fg=fg,font=("times new roman", 14, "bold")).grid(row=2, column=0, padx=20, pady=1, sticky="w")
        ...
        c1_lbl = Label(F6, text="Cosmaetic Tax", bg=bg_color, fg=fg,font=("times new roman", 14, "bold")).grid(row=0, column=2, padx=20, pady=1, sticky="w")
        ...
        c2_lbl = Label(F6, text="Grocery Tax", bg=bg_color, fg=fg,font=("times new roman", 14, "bold")).grid(row=1, column=2, padx=20, pady=1, sticky="w")
        ...
        c3_lbl = Label(F6, text="Cold Drinks Tax",bg=bg_color, fg=fg,font=("times new roman", 14, "bold")).grid(row=2, column=2, padx=20, pady=1, sticky="w")
        ...
        total_btn=Button(btn_F,text="Total",command=self.total,bg=fg,fg="white",pady=15,width=10,bd=2,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn = Button(btn_F, text="Genrate Bill",command=self.bill_area, bg=fg, fg="white", pady=15, width=10, bd=2,font="arial 15 bold").grid(row=0, column=1, padx=5, pady=5)
        clear_btn=Button(btn_F,text="Claer",command=self.clear_data,bg=fg,fg="white",pady=15,width=10,bd=2,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg=fg,fg="white",pady=15,width=10,bd=2,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    def total(self):
    ...
    def welcome_bill(self):
        ...
        self.textarea.insert(END,"\tBrotherhood Super Shop \n")
